...
$(window).scroll(function (event) {
  ...
  if (st > 200 && st > lastScrollTop) {
    $('.page-wrap, .footer').addClass('scrolling_down');
    $('.page-wrap, .footer').removeClass('scrolling_up')
  } else {
    $('.page-wrap, .footer').addClass('scrolling_up');
    $('.page-wrap, .footer').removeClass('scrolling_down')
  }
  lastScrollTop = st;
  if (st == 0) {
    $('.page-wrap, .footer').removeClass('scrolling_up')
